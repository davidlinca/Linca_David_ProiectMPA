...
namespace Linca_David_ProiectMPA
{
    public partial class TypePredictionModel
    {
        public const string RetrainFilePath =  @"C:\Users\ASUS\Downloads\training_netflix_titles.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"title",outputColumnName:@"title")      
                                    .Append(mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"director",outputColumnName:@"director"))      
                                    .Append(mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"cast",outputColumnName:@"cast"))      
                                    .Append(mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"duration",outputColumnName:@"duration"))      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"title",@"director",@"cast",@"duration"}))      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator: mlContext.BinaryClassification.Trainers.LbfgsLogisticRegression(new LbfgsLogisticRegressionBinaryTrainer.Options(){L1Regularization=1F,L2Regularization=1F,LabelColumnName=@"type",FeatureColumnName=@"Features"}), labelColumnName:@"type"))      
